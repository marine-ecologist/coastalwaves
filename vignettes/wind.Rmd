...
`get_wind_data` extracts daily Sea Surface Wind data from the NOAA NCEI blended daily averaged 0.25° (1987-recent) 
...
`get_weather_data` extracts data from a list of Weather Underground stations:
